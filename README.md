...
#### rooms
    ...
    `Предназначена для хранения участноков общения.`
...
#### groups
    ...
    `Группы общения. в группе всегда присутствует не менее 2 участников. Ввсегда хотябы один не забанен.`
    `Собщения всегда привязаны к группе`
